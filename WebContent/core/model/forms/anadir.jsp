...
<div class="contain">
	...
	<%-- 
		...
		<form method="post" action="agenda?operacion=anadir">
			...
			<input type="text" pattern="[0-9]{9}" placeholder="movil 999999999" name="movil" value="telefono movil">
			<input type="text" pattern="[0-9]{9}" placeholder="fijo 999999999" name="fijo" value="telefono fijo">
			<textarea name="anotaciones" placeholder="anotaciones">anotaciones</textarea>
			
			<div class="botones">
				<a title="" href="index.jsp">cancelar</a>
				<input type="submit" value="insertar" name="anadir" class="boton anadir">
			</div>
		</form>
</div>
<!-- FOOTER -->
